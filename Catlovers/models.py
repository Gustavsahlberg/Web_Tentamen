...
class Contact(db.Model):
    ...
    ContactMail = db.Column(db.String(40), unique=False, nullable=True)
    ContactTelefon = db.Column(db.String(30), unique=False, nullable=True)
    ContactÄrende = db.Column(db.String(40), unique=False, nullable=False)
    ContactMsg= db.Column(db.String(512), unique=False, nullable=False)
